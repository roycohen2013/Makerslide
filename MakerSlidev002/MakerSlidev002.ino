...
#define LIM_SWITCH_RIGHT 5
#define LIM_SWITCH_LEFT 6
...
void setup()
{
  ...
  if (myCamSlider.maxSpeed < 1)
    myCamSlider.maxSpeed = DEFAULT_MAX_SPEED;
    
  if (myCamSlider.maxAccel < 1)
  ...
  // setup output pins
  pinMode(LIM_SWITCH_RIGHT, INPUT);
  pinMode(LIM_SWITCH_LEFT, INPUT);
  ...
  clearLCD();
  lcdPosition(0,0);
  LCD.print("control system initialized");
